        ...
        <Card className="bg-card/80 backdrop-blur-sm border border-border/20">
          ...
          <CardContent className="space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <p>
                SimuSoul is an application designed to let you create, customize, and interact with unique AI-powered personas. Whether for creative writing, role-playing, or simply exploring the potential of conversational AI, SimuSoul provides a sandboxed environment for your imagination. All your data, including persona details and chat histories, is stored locally and securely in your browser's IndexedDB, ensuring your creations remain private.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>AI Interaction Data:</strong> To enable chat functionality, your conversation prompts (including persona details and chat history) are sent to third-party AI providers (Groq, Pollinations.ai). Please be aware that this data is subject to each provider's own privacy policies and terms of service.</li>
