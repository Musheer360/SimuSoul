...
function buildChatPrompt(input: ChatWithPersonaInput): string {
  ...
  **Core Instructions & Content Restrictions (NON-NEGOTIABLE):**
  ...
  4.  **Avoid Repetition (CRITICAL):** You have access to the full conversation history. Do NOT repeat points you have already made or ask questions you have already asked. Keep the conversation fresh and engaging. Your responses must feel original and specific to the user's latest message.
